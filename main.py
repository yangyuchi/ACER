...
parser.add_argument('--replay-start', type=int, default=20000, metavar='EPISODES',
...
parser.add_argument('--num-hidden', type=int, default=100, metavar='SIZE', help='Number of hidden neurons')
...
parser.add_argument('-c', type=float, default=10, metavar='c', help='Importance weight truncation (max) value')
...
parser.add_argument('--learning-rate', type=float, default=0.0007, metavar='η', help='Learning rate')
...
def job():
    agent.acer_main(args, coord, average_net)
